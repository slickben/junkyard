...
const getAnalytics = async (year: number) => {
  ...
  await $fetch(`${useBaseUrl()}/super/analytics?year=${year}`, {
    headers: {
...
<template>
  <div
    class="rounded-xl border md:border-none bg-gray-50 md:bg-transparent md:shadow-card-shadow backdrop-blur-xl flex flex-col gap-2 md:gap-4 w-full p-4 md:p-6 relative h-max mt-10"
  >
